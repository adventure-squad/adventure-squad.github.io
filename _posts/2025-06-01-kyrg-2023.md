...
{% include gallery-grid.html folder="assets/images/fulls/kyrg" captions="Camping on the mountainside|Ascending the steppes|Rocky peaks|By the river" %}
...
{% include image.html url="/assets/images/fulls/kyrg/DSCF1996.JPG" description="Mountains" %}
